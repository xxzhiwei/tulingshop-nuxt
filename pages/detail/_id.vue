            ...
            <div class="container clearfix">
                ...
                <div class="content">
                    ...
                    <div class="item-version clearfix">
                        <h2>选择规格</h2>
                        <div class="phone fr" v-for="(item, index) of product.skuStockList" :key="index" :class="[ {checked: clicked == index},{disabled: (item.stock-item.lockStock)<=0} ]" :skuId="item.id" @click="handlerSkuid(item, index)">
                            {{ item.sp1 + item.sp2 }}
                        </div>
                    </div>
            ...
            this.axios
                ...
                .then(() => {
                    this.$message.success({
                        ...
                        message:
                            "添加购物车成功，请点击<a href='/*/cart'>购物车</a>查看",
                    });
                });
        },
